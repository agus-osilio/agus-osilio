<div align="center">
  <img src="./building.png" width="500"/>
</div>

---

# AI Automation Engineer · LLM Agents & Integration | AI Engineer · Python · FastAPI · APIs · MCP · Docker | Fintech + ops · From problem to production

Hi! 👋 I'm Agustín. I build tools that work, end-to-end, with AI as the main lever. When I face a problem, I break it down, design the architecture, and work it through until it runs in production, including the debugging and iteration.
 
I combine technical depth with business context to ship complete solutions: from automations to conversational agents, generative AI pipelines, and tools that solve real problems.
